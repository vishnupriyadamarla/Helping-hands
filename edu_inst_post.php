<?php
//require "header.php";
if(isset($_POST['edu_inst_post'])){
  session_start();
 require_once "connect.php";
    $image=$_FILES['image'];
    $target_dir = "uploads/edu_inst/";
...
if($uploadOk==1)
  $q="insert into edu_inst values('".$_POST['email']."','".$_POST['name']."',".$_POST['pp_primary'].",".$_POST['pp_secondary'].",".$_POST['pp_inter'].",".$_POST['pp_ug'].",".$_POST['pp_pg'].",'".$_POST['about']."','".$_POST['phone']."','".basename($image["name"])."');";
else
  $q="insert into edu_inst values('".$_POST['email']."','".$_POST['name']."',".$_POST['pp_primary'].",".$_POST['pp_secondary'].",".$_POST['pp_inter'].",".$_POST['pp_ug'].",".$_POST['pp_pg'].",'".$_POST['about']."','".$_POST['phone']."',NULL);";
...
<br><br>
<form  method="post"   action="edu_inst_post.php" enctype="multipart/form-data" >
  ...
  <br>
    <div class="form-group row">
      ...
      <div class="col-lg-4"><input type="submit" name="edu_inst_post" value="SUBMIT" class="btn btn-primary"></div>
      <div class="col-lg-4"></div>
    </div></form>