<?php
//require "header.php";
if(isset($_POST['sponsers_post'])){
  session_start();
  require_once "connect.php";
    $image=$_FILES['image'];
    $target_dir = "uploads/sponsers/";
...
if($uploadOk==1)
  $q="insert into sponsers values('".$_POST['email']."','".$_POST['name']."',".$_POST['VollyBall'].",".$_POST['Tennis'].",".$_POST['Cricket'].",".$_POST['Kabaddi'].",".$_POST['Athletics'].",".$_POST['Chess'].",'".$_POST['about']."','".$_POST['phone']."','".basename($image["name"])."');";
else
  $q="insert into sponsers values('".$_POST['email']."','".$_POST['name']."',".$_POST['VollyBall'].",".$_POST['Tennis'].",".$_POST['Cricket'].",".$_POST['Kabaddi'].",".$_POST['Athletics'].",".$_POST['Chess'].",'".$_POST['about']."','".$_POST['phone']."',NULL);";
...
<br><br>
<form  method="post"   action="sponsers_post.php"  enctype="multipart/form-data" >
  ...
  <br>
    <div class="form-group row">
      <div class="col-lg-4"></div>
      <div class="col-lg-4"><input type="submit" name="sponsers_post" value="SUBMIT" class="btn btn-primary"></div>
      <div class="col-lg-4"></div>  
    </div></form>